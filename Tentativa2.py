...
#Constantes para cálculo de tempo de recarga e consumo de bateria
CONST_TEMPO_RECARGA = 0.2
CONST_CONSUMO_BATERIA = 1
#Constantes para definir nível de cargas mínimo e máximo que os carros entram no sistema
CONST_BATERIA_MINIMO = 50
CONST_BATERIA_MAXIMO = 90
...
class Posto:
    ...
    def recarga(self,env,carro):
        ...
        carro.qtde_carga -= abs(self.localizacao - carro.localizacao) * CONST_CONSUMO_BATERIA
        ...
        with self.num_tomada.request() as tomada:
            ...
            yield self.env.timeout((100 - carro.qtde_carga) * CONST_TEMPO_RECARGA)
...
def defCarros(qtde_carros):
    ...
    for i in range(qtde_carros):
        ...
        carga = random.randint(CONST_BATERIA_MINIMO,CONST_BATERIA_MAXIMO)
